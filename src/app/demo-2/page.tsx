...
import {
	...
	useSeatSelection,
} from "@/hooks/use-seat-selection-v2";
import { useZoom } from "@/hooks/use-zoom";
import { formatCurrency } from "@/lib/formatter";
import { initialSeats } from "@/lib/seat-data-v2";
import { type PickSeatRes, type Seat } from "@/lib/seat-v2";
...
export default function DemoTwoPage(): JSX.Element {
	...
	const submitSelectSeat = useCallback(async () => {
		...
		try {
			const rawRes = await fetch("/api/select-seat-v2", {
				method: "POST",
				headers: {
